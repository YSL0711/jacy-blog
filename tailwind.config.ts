  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        tree: {
          bg: "hsl(var(--tree-bg))",
          ivory: "hsl(var(--tree-text-ivory))",
          muted: "hsl(var(--tree-text-muted))",
        },
        ornament: {
          cranberry: "hsl(var(--ornament-cranberry))",
          gold: "hsl(var(--ornament-gold))",
          mint: "hsl(var(--ornament-mint))",
          lavender: "hsl(var(--ornament-lavender))",
          silver: "hsl(var(--ornament-silver))",
          blue: "hsl(var(--ornament-blue))",
        },
